  ...
  return (
    <div className="min-h-screen bg-flock-cream">
      ...
      <aside className="fixed inset-y-0 left-0 z-20 hidden w-60 flex-col bg-flock-soil md:flex">
        ...
        <nav className="flex-1 space-y-1 px-3 py-2">
          {NAV.map((n) => (
            <Link
              ...
              className="flex items-center gap-3 rounded-lg px-3 py-2.5 font-sans text-[13.5px] text-flock-cream/70 transition hover:bg-white/5 hover:text-flock-cream"
            >
        ...
        <button
          onClick={signOut}
          className="m-3 flex items-center gap-3 rounded-lg px-3 py-2.5 font-sans text-[13.5px] text-flock-cream/70 transition hover:bg-white/5 hover:text-flock-cream"
        >
      ...
      <div className="md:pl-60">
        ...
        <header className="sticky top-0 z-10 border-b border-flock-fog bg-flock-cream/95 px-6 backdrop-blur">
          <div className="flex h-16 items-center gap-4">
            <button className="flex items-center gap-2 rounded-lg border bg-flock-fog px-3 py-1.5 font-sans text-[13px] text-flock-soil transition hover:bg-flock-mist">
              <Bird className="h-3.5 w-3.5 text-flock-field" /> My Farm
              <ChevronDown className="h-3.5 w-3.5 text-flock-stone" />
            </button>
            <div className="ml-auto flex items-center gap-3">
              {actions}
              <button className="relative flex h-9 w-9 items-center justify-center rounded-lg border bg-flock-fog text-flock-soil transition hover:bg-flock-mist">
